...
use crate::ast::{Span, TypeRef, TypeDecl, FunctionDecl};
...
impl SemanticAnalyzer {
    ...
    pub(super) fn is_compatible_type(&self, expected: &SemanticType, actual: &SemanticType) -> bool {
    ...
    pub(super) fn protocol_conforms_to_protocol(&self, actual_name: &str, expected_name: &str) -> bool {
        if actual_name == expected_name {
            return true;
        }
    ...
    pub(super) fn collect_protocol_methods(&self, protocol_name: &str) -> Option<HashMap<String, SemanticType>> {
    ...
    pub(super) fn resolve_member_type(&mut self, object_type: &SemanticType, member: &str, span: Span) -> SemanticType {
    ...
    pub(super) fn lookup_member_type_in_parent_chain(&self, type_name: &str, member: &str) -> Option<SemanticType> {
    ...
    pub(super) fn lookup_protocol_member_type(&self, protocol_name: &str, member: &str) -> Option<SemanticType> {
    ...
    pub(super) fn validate_parent_constructor_args(&mut self, typ: &TypeDecl, parent_name: &str, parent_shape: &super::TypeShape) {
    ...
    pub(super) fn resolve_type_ref(&mut self, type_ref: Option<&TypeRef>, span: Span) -> SemanticType {
    ...
    pub(super) fn expect_type(&mut self, span: Span, actual: &SemanticType, expected: &SemanticType, ctx: &str) {
