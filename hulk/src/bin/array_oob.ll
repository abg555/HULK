...
entry:
  ...
  %vec_len_slot2 = getelementptr inbounds { i64, ptr }, ptr %vec_alloc, i32 0, i32 0
  %vec_len = load i64, ptr %vec_len_slot2, align 4
  %idx_lt_len = icmp ult i64 3, %vec_len
  %idx_valid = and i1 true, %idx_lt_len
  br i1 %idx_valid, label %index_ok, label %index_fail

index_ok:                                         ; preds = %entry
  %elem_i8 = getelementptr inbounds i8, ptr %data_ptr, i64 mul (i64 ptrtoint (ptr getelementptr (double, ptr null, i32 1) to i64), i64 3)
